...
def inference_sond(
    ...
    def _forward(
        ...
        print(f"raw_inputs_forward type: {type(raw_inputs)}")
        logging.info("param_dict: {}".format(param_dict))
